        ...
        <AnimatePresence>
            {count > 0 && (
                <motion.div
                    ...
                    className="fixed bottom-6 left-1/2 z-40 w-[calc(100%-2rem)] max-w-md bg-zinc-900/95 dark:bg-white/95 backdrop-blur-md rounded-[1.25rem] p-3 shadow-2xl border border-zinc-800/50 dark:border-zinc-200/50 text-white dark:text-zinc-900 flex items-center justify-between"
                >
